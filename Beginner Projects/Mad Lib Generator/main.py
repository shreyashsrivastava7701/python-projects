...
while True:
    if story_choose == 1:
        ...
        story1 = story_1(emo, color, weather, cloth, adj, footwear, verb, vehicle, city, direction, adj2, noun, food, restaurant, temp, verb2, animal, furniture, adj3)
        print(story1)
        ...
        story2 = story_2(noun, noun2, verb, noun3, verb2, noun4, noun5, noun6)
        print(story2)
